  ...
  return (
    <div className='fixed top-0 flex w-full justify-between px-32 py-8'>
      ...
      <div className='flex gap-8 items-center'>
        ...
        <Link href='/' className='border-b-2 border-transparent hover:border-white'>Speakers</Link>
        <Link href='/ticket' className='border-b-2 border-transparent hover:border-white'>Ticket</Link>
        <Link href='/' className='border-b-2 border-transparent hover:border-white'>Contact</Link>
